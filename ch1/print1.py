...
Traceback (most recent call last):
  File "c:\source\pythonsource\ch1\print1.py", line 42, in <module>
    print("%d : %d " %1, "홍길동")
          ~~~~~~~~~~~^~
...
print("I ate {0} apple. so I was sick for {day} day".format(10, day = 3))

# format() + 인덱스 + 정렬
print("{0:<10}".format("hi")) # 총 자릿수 10으로 왼쪽 정렬
print("{0:>10}".format("hi")) # 총 자릿수 10으로 오른쪽 정렬
print("{0:^10}".format("hi")) # 총 자릿수 10으로 가운데 정렬
